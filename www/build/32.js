webpackJsonp([32],Array(286).concat([
/* 286 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__verification__ = __webpack_require__(445);
...
var VerificationModule = (function () {
    ...
    VerificationModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__verification__["a" /* Verification */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__verification__["a" /* Verification */]
            ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment__ = __webpack_require__(290);
...
var Verification = (function () {
    function Verification(navCtrl, navParams, viewCtrl, alertCtrl) {
    ...
    Verification.prototype.startTimer = function () {
        var newDateObj = __WEBPACK_IMPORTED_MODULE_2_moment__().add(121, 's');
        this.countdown(newDateObj);
    };
    Verification.prototype.getRemainTime = function (deadline) {
        var now = new Date(), deadl = __WEBPACK_IMPORTED_MODULE_2_moment__(new Date(deadline)), remainTime = deadl.diff(now, 'seconds'), remainSeconds = ('0' + remainTime % 60).slice(-2), remainMinutes = ('0' + Math.floor(remainTime / 60 % 60)).slice(-2);
        return { remainTime: remainTime, remainSeconds: remainSeconds, remainMinutes: remainMinutes };
    };
    Verification.prototype.countdown = function (deadline) {
        var _this = this;
        var i = 0;
        var timerUpdate = setInterval(function () {
            var t = _this.getRemainTime(deadline);
            _this.timer = t.remainMinutes + ":" + t.remainSeconds;
            if (t.remainTime < 1) {
    ...
    Verification.prototype.showAlert = function () {
        var _this = this;
            ...
            buttons: [
                {
                    ...
                    handler: function (data) {
                        _this.navCtrl.push('Verification');
                    }
                },
            ],
        });
    ...
    Verification.prototype.back = function () {
